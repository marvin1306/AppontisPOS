...
<div id="main-wrapper">
 ...
 background-color:rgb(10, 10, 10);background-size:cover">
      <div class="row">
          ...
          <div class="login-content">
            <div class="login-form">
              ...
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm">
                ...
                <button type="submit" name="login" class="f-w-600 btn btn-primary btn-flat m-b-30 m-t-30 style=" background:blue;">Ingresar</button>
...
<a href="#" class="text-right f-w-600"> Forgot Password?</a>
                ...
                <div class="forgot-phone text-left f-left">
                  <a href="https://www.appontis.com" class="text-right f-w-600"> Para más desarrollos APPONTIS</a>
                </div>
              </form>
            </div>
          </div>
